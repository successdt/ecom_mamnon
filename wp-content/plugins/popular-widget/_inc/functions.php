		...
		*/
		function display_post_tab_content( $posts ){
			...
			foreach( $posts as $key => $post ){
				...
				if($youtube['id']) {
					$image = '<img src="http://img.youtube.com/vi/'. $youtube['id'].'/default.jpg" class="rpwe-alignleft rpwe-thumb wp-post-image" alt="' . wp_specialchars($post->post_title , 1) . '" class="album-thumb">'; 
				}
